...
export const ASSERTOOR_ROOT = path.join(
  process.cwd(),
  SERVICES_ROOT,
  "assertoor",
);
export const BLOCKSCOUT_ROOT = path.join(
  process.cwd(),
  SERVICES_ROOT,
  "blockscout",
);
...
export const DEPOSIT_CLI_ROOT = path.join(
  SUBMODULES_ROOT,
  "staking-deposit-cli",
);
...
export const PARSED_CONSENSUS_GENESIS_FILE =
  "network/parsed/parsedConsensusGenesis.json";
